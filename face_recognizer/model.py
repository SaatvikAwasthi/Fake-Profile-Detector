...
from face_recognizer.utils import LRN2D
...
def create_model():
    ...
    # Inception3c
    inception_3c_3x3 = face_recognizer.utils.conv2d_bn(inception_3b,
    ...
    inception_3c_5x5 = face_recognizer.utils.conv2d_bn(inception_3b,
    ...
    # inception 4a
    inception_4a_3x3 = face_recognizer.utils.conv2d_bn(inception_3c,
                                                       ...
                                                       cv2_strides=(1, 1),
                                                       padding=(1, 1))
    inception_4a_5x5 = face_recognizer.utils.conv2d_bn(inception_3c,
    ...
    inception_4a_pool = face_recognizer.utils.conv2d_bn(inception_4a_pool,
                                                        layer='inception_4a_pool',
                                                        cv1_out=128,
                                                        cv1_filter=(1, 1),
                                                        padding=(2, 2))
    inception_4a_1x1 = face_recognizer.utils.conv2d_bn(inception_3c,
    ...
    # inception4e
    inception_4e_3x3 = face_recognizer.utils.conv2d_bn(inception_4a,
                                                       ...
                                                       cv2_strides=(2, 2),
                                                       padding=(1, 1))
    inception_4e_5x5 = face_recognizer.utils.conv2d_bn(inception_4a,
    ...
    # inception5a
    inception_5a_3x3 = face_recognizer.utils.conv2d_bn(inception_4e,
    ...
    inception_5a_pool = face_recognizer.utils.conv2d_bn(inception_5a_pool,
                                                        layer='inception_5a_pool',
                                                        cv1_out=96,
                                                        cv1_filter=(1, 1),
                                                        padding=(1, 1))
    inception_5a_1x1 = face_recognizer.utils.conv2d_bn(inception_4e,
    ...
    # inception_5b
    inception_5b_3x3 = face_recognizer.utils.conv2d_bn(inception_5a,
    ...
    inception_5b_pool = face_recognizer.utils.conv2d_bn(inception_5b_pool,
                                                        layer='inception_5b_pool',
                                                        cv1_out=96,
                                                        cv1_filter=(1, 1))
    inception_5b_pool = ZeroPadding2D(padding=(1, 1))(inception_5b_pool)

    inception_5b_1x1 = face_recognizer.utils.conv2d_bn(inception_5a,
